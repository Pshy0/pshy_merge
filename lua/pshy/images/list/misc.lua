...
--
-- Misc images to extend `pshy.images.list`.
--
...
images["1557c364a52.png"] = {w = 150, h = 100, desc = "mouse"} -- @TODO: resize
images["155c49d0331.png"] = {w = 60, h = 33, desc = "horse"}
...
images["1569ed22fca.png"] = {TFM = true, furniture = true, desc = ""} -- Estante de livros
images["1569edb5d05.png"] = {TFM = true, furniture = true, desc = ""} -- Estante de livros (invertida)
images["1569ec80946.png"] = {TFM = true, furniture = true, desc = ""} -- Lareira
images["15699c75f35.png"] = {TFM = true, furniture = true, desc = ""} -- Lareira (invertida)
images["1569e9e54f4.png"] = {TFM = true, furniture = true, desc = ""} -- Caixão
images["15699c67278.png"] = {TFM = true, furniture = true, desc = ""} -- Caixão (invertido)
images["1569e7e4495.png"] = {TFM = true, furniture = true, desc = ""} -- Cemiterio
images["156999e1f40.png"] = {TFM = true, furniture = true, desc = ""} -- Cemiterio (invertido)
images["156999ebf03.png"] = {TFM = true, furniture = true, desc = ""} -- Árvore de natal
images["1569e7d3bac.png"] = {TFM = true, furniture = true, desc = ""} -- Arvore de natal (invertida)
images["1569e7ca20e.png"] = {TFM = true, furniture = true, desc = ""} -- Arvore com neve
images["156999e6b7e.png"] = {TFM = true, furniture = true, desc = ""} -- Árvore com neve (invertida)
images["155a7b9a815.png"] = {TFM = true, furniture = true, desc = ""} -- Árvore
images["1569e788f68.png"] = {TFM = true, furniture = true, desc = ""} -- Árvore (invertida)
images["155a7c4e15a.png"] = {TFM = true, furniture = true, desc = ""} -- Flor vermelha
images["155a7c50a6b.png"] = {TFM = true, furniture = true, desc = ""} -- Flor azul
images["155a7c834a4.png"] = {TFM = true, furniture = true, desc = ""} -- Janela
images["1569e9bfb87.png"] = {TFM = true, furniture = true, desc = ""} -- Janela (invertida)
images["155a7ca38b7.png"] = {TFM = true, furniture = true, desc = ""} -- Sofá
images["156999f093a.png"] = {TFM = true, furniture = true, desc = ""} -- Palmeira
images["1569e7706c4.png"] = {TFM = true, furniture = true, desc = ""} -- Palmeira (invertido)
images["15699b2da1f.png"] = {TFM = true, furniture = true, desc = ""} -- Estante de halloween
images["1569e77e3a5.png"] = {TFM = true, furniture = true, desc = ""} -- Estante de halloween (invertido)
images["1569e79c9e3.png"] = {TFM = true, furniture = true, desc = ""} -- Árvore do outono
images["15699b344da.png"] = {TFM = true, furniture = true, desc = ""} -- Árvore do outono (invertida)
images["1569e773235.png"] = {TFM = true, furniture = true, desc = ""} -- Abobora gigante
images["15699c5e038.png"] = {TFM = true, furniture = true, desc = ""} -- Piano
images["15699c3eedd.png"] = {TFM = true, furniture = true, desc = ""} -- Barril
images["15699b15524.png"] = {TFM = true, furniture = true, desc = ""} -- Guada roupa
images["1569e7ae2e0.png"] = {TFM = true, furniture = true, desc = ""} -- Guarda roupa (invertido)
images["1569edb8321.png"] = {TFM = true, furniture = true, desc = ""} -- Baú
images["1569ed263b4.png"] = {TFM = true, furniture = true, desc = ""} -- Baú (invertido)
images["1569edbaea9.png"] = {TFM = true, furniture = true, desc = ""} -- Postêr
images["1569ed28f41.png"] = {TFM = true, furniture = true, desc = ""} -- Postêr (invertido)
images["1569ed2cb80.png"] = {TFM = true, furniture = true, desc = ""} -- Boneco de neve
images["1569edbe194.png"] = {TFM = true, furniture = true, desc = ""} -- Boneco de neve (invertido)
-- mice as objets (source: Natsmiro https://discord.com/channels/246815328103825409/501743449490325514/819304591857942569)
images["1781d7ed29d.png"] = {TFM = true, w = 130, h = 30, desc = "short mouse plank"}
...
images["14e555a4c1b.jpg"] = {TFM = true, background = true, desc = ""} -- Mapa Independence Day
images["14e520635b4.png"] = {TFM = true, background = true, desc = ""} -- Estatua da liberdade(Mapa Independence Day)
images["14e78118c13.jpg"] = {TFM = true, background = true, desc = ""} -- Mapa Bastille Day
images["14e7811b53a.png"] = {TFM = true, background = true, desc = ""} -- Folha das arvores(Mapa Bastille Day)
images["149c04b50ac.jpg"] = {TFM = true, background = true, desc = ""} -- Mapa do ceifador
images["149c04bc447.png"] = {TFM = true, background = true, desc = ""} -- Mapa do ceifador(partes em primeiro plano)
images["14abae230c8.jpg"] = {TFM = true, background = true, desc = ""} -- Mapa Rua Nuremberg
images["14aa6e36f3e.png"] = {TFM = true, background = true, desc = ""} -- Mapa Rua Nuremberg(partes em primeiro plano)
images["14a88571f89.jpg"] = {TFM = true, background = true, desc = ""} -- Mapa Fabrica de brinquedos
images["14a8d41a838.jpg"] = {TFM = true, background = true, desc = ""} -- Mapa dia das crianças
images["14a8d430dfa.png"] = {TFM = true, background = true, desc = ""} -- Mapa dia das crianças(partes em primeiro plano)
images["15150c10e92.png"] = {TFM = true, background = true, desc = ""} -- Mapa de ano novo
-- TFM Particles (source: Tempo https://atelier801.com/topic?f=6&t=877911#m7)
images["1674801ea08.png"] = {TFM = true, particle = true, desc = ""} -- Raiva
images["16748020179.png"] = {TFM = true, particle = true, desc = ""} -- Palmas
images["167480218ea.png"] = {TFM = true, particle = true, desc = ""} -- Confete
images["1674802305b.png"] = {TFM = true, particle = true, desc = ""} -- Dança
images["167480247cc.png"] = {TFM = true, particle = true, desc = ""} -- Facepalm
images["16748025f3d.png"] = {TFM = true, particle = true, desc = ""} -- High five
images["167480276af.png"] = {TFM = true, particle = true, desc = ""} -- Abraçar
images["16748028e21.png"] = {TFM = true, particle = true, desc = ""} -- Pedir Beijo
images["1674802a592.png"] = {TFM = true, particle = true, desc = ""} -- Beijar
images["1674802bd07.png"] = {TFM = true, particle = true, desc = ""} -- Risada
images["1674802d478.png"] = {TFM = true, particle = true, desc = ""} -- Pedra papel tesoura
images["1674802ebea.png"] = {TFM = true, particle = true, desc = ""} -- Sentar
images["1674803035b.png"] = {TFM = true, particle = true, desc = ""} -- Dormir
images["16748031acc.png"] = {TFM = true, particle = true, desc = ""} -- Chorar
-- Pokemon (source: Shamousey https://atelier801.com/topic?f=6&t=827044&p=1#m6)
-- Mario
images["156d7dafb2d.png"] = {mario = true, desc = "mario (undersized)"} -- @TODO: replace whith a properly sized image
images["17aa6f22c53.png"] = {mario = true, w = 27, h = 38, desc = "mario coin"}
